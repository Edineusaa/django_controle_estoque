...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nome', models.CharField(max_length=150, verbose_name='Fornecedor do Produto')),
                ('contato', models.CharField(max_length=15, verbose_name='Contato do Fornecedor')),
                ('cnpj', models.CharField(max_length=14, unique=True, verbose_name='CNPJ do Fornecedor')),
            ],
            options={
